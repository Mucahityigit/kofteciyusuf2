    ...
    <div id="container">
        ...
        <div class="hesapAlani">
            ...
            <div id="hesapCercevesi">
                    <?php 
                    $toplam = 0;
                    $gelenurunlersorgusu = $db -> prepare("SELECT * FROM masalar INNER JOIN siparisler ON masalar.masa_id=siparisler.masa_id INNER JOIN urunler ON urunler.urun_id = siparisler.urun_id WHERE siparisler.masa_id=$masa_id AND masalar.masa_durumu='BOS'");
